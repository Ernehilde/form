...
class DataTransaksiDashboard extends StatelessWidget {
  const DataTransaksiDashboard({super.key});
                ...
                child: TextButton(
                  ...
                  child: Row(
                    children: [
                      ...
                      Text(
                        'Laporan Data Transaksi Pengujian',
                        style: GoogleFonts.poppins(
                ...
                child: TextButton(
                  ...
                  child: Row(
                    children: [
                      ...
                      Text(
                        'Laporan Data Terima Hasil Test',
                        style: GoogleFonts.poppins(
                            fontSize: 18, color: Colors.white),
                      )
                    ],
